...
public class Product {
	 ...
	 */
	private final ObservableList<com.inventory.Part> associatedParts;
	/**
	...
	public Product(int id, String name, double price, int stock, int min, int max,
	               ObservableList<com.inventory.Part> associatedParts) {
		this.id = id;
		this.name = name;
		this.price = price;
		this.stock = stock;
	 ...
	 */
	public void addAssociatedPart(com.inventory.Part part) {
	 ...
	 */
	public boolean deleteAssociatedPart(com.inventory.Part selectedAssociatedPart) {
	 ...
	 */
	public ObservableList<com.inventory.Part> getAllAssociatedParts() {
