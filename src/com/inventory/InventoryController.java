...
public class InventoryController implements Initializable {
	...
	@FXML
	public void generatePartsReport(ActionEvent event) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/inventory/partsReport.fxml"));
			Parent root = loader.load();
			Stage stage = new Stage();
			stage.setTitle("Parts Report");
			stage.setScene(new Scene(root));
			stage.show();
		} catch (IOException e) {
			System.err.println("Error loading parts report window: " + e.getMessage());
			e.printStackTrace();
		}
	}
	...
	public void generateProductsReport(ActionEvent event) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/inventory/productsReport.fxml"));
			Parent root = loader.load();
			Stage stage = new Stage();
			stage.setTitle("Products Report");
			stage.setScene(new Scene(root));
			stage.show();
		} catch (IOException e) {
			e.printStackTrace();
